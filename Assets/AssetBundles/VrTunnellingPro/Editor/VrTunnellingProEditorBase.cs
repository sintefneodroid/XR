...
using AssetBundles.VrTunnellingPro.Scripts;
using UnityEditor;
using UnityEngine;

namespace AssetBundles.VrTunnellingPro.Editor {
	public abstract class VrTunnellingProEditorBase : UnityEditor.Editor {
	...
	public class VrtpAboutWindow : EditorWindow {
		...
		public static void Open(){
			if (_i == null){
				...
				_i.titleContent = new GUIContent("About VRTP v" + TunnellingBase.VRTP_VERSION);
		...
		void OnGUI(){
			...
			EditorGUILayout.LabelField("Version " + TunnellingBase.VRTP_VERSION);
