...
namespace SceneAssets.Common.Interaction.Scripts
{
  ...
  public class ToggleOutline : MonoBehaviour {
    ...
    void Awake() {
      ...
      if (onlyDrawOnActivatorCollision && activator_collider == null){
        activator_collider = GetComponent<Collider>();
      }
    ...
    void OnEnable(){
      if (!onlyDrawOnActivatorCollision){
        EnableOutline();
      }
    }

    private void OnCollisionEnter(Collision other){
      if (other.gameObject.CompareTag(activator_tag)){
        EnableOutline();
      }
    }
    ...
    {
      if (other.gameObject.CompareTag(activator_tag)){
        DisableOutline(); //TODO: Check if still has another activator colliding 
      }
    }

    private void OnTriggerEnter(Collider other){
      if (other.CompareTag(activator_tag)){
        EnableOutline(); 
      }
    }
    ...
    void LoadSmoothNormals() {
      ...
      foreach (var skinnedMeshRenderer in GetComponentsInChildren<SkinnedMeshRenderer>()) {
        ...
        if (_registeredMeshes.Add(sharedMesh)){
