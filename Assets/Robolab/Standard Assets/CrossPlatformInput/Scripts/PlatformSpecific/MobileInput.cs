...
namespace UnityStandardAssets.CrossPlatformInput.PlatformSpecific {
  public class MobileInput : VirtualInput {
    ...
    public override float GetAxis(string name, bool raw) {
      if (!this.m_VirtualAxes.ContainsKey(name)) this.AddAxes(name);
      return this.m_VirtualAxes[name].GetValue;
    }

    public override void SetButtonDown(string name) {
      if (!this.m_VirtualButtons.ContainsKey(name)) this.AddButton(name);
    ...
    public override bool GetButtonUp(string name) {
      if (this.m_VirtualButtons.ContainsKey(name)) return this.m_VirtualButtons[name].GetButtonUp;
    ...
    public override bool GetButton(string name) {
      if (this.m_VirtualButtons.ContainsKey(name)) return this.m_VirtualButtons[name].GetButton;
